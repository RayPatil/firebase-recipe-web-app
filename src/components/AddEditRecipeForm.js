        ...
        <div className="ingredients-list">
                            ...
                            return (
                                <tr key={ingredient}>
                                    ...
                                    <td className="ingredient-delete-box">
                                        <button className="secondary-button ingredient-delete-button">Delete</button>
                                    </td>
                                </tr>
                            )
                        }) : null
            ...
            <div className="ingredients-form">
                <label className="ingredient-label">
                    Ingredient:
                    <input type="text" value={ingredientName} onChange={(e) => setIngredientName(e.target.value)} className="input-text" onKeyPress={handleAddIngredient} placeholder='ex. 1 cup of sugar' />
                </label>
