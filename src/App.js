...
function App() {
  ...
  async function fetchRecipes(cursorId = '') {
    ...
    try {
      const response = await FirebaseFirestoreService.readDocuments({
        collection: 'recipes', queries: queries, orderByField: orderByField, orderByDirection: orderByDirection, perPage: recipesPerPage,
        cursorId: cursorId,
      });
  ...
  async function handleAddRecipe(newRecipe) {
    try {
      ...
      handleFetchRecipes();
      //todo :featch new recipe from firestor
  ...
  function lookupsCategoryLabel(categoryKey) {
    const categories = {
                  ...
                  return (
                    <div className="recipe-card" key={recipe.id}>
                      ...
                      <div className="recipe-field">
                        Category: {lookupsCategoryLabel(recipe.category)}
                      </div>
                      <div className="recipe-field">
